...
3. and modify the Web.Config it to your web.config connection strings. LIkely you can do a find and replace replacing 'aspnet-dot-not-a-goat-20170602044944' with 'scat'.
